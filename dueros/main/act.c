...
static duer_status_t bits_switch(duer_context ctx, duer_msg_t *msg, duer_addr_t *addr)
{
	ESP_LOGI(TAG, "Recieve cmd.............................");
...
void bits_regist_resource(void){
	duer_res_t res[] = {
		  ...
		  {DUER_RES_MODE_DYNAMIC, DUER_RES_OP_PUT | DUER_RES_OP_GET, "bits_switchOnOff",.res.f_res = bits_switch},
	};
